...
import {
  ...
  CarouselPrevious,
  CarouselNext,
} from "../components/ui/carousel"; // Custom Carousel components
import { FaLink } from "react-icons/fa6"; // Icon for link overlay
...
//             {/* Loop through blogs array to render items */}
//             {blogs.map((item, i) => {
//               return (
//                 <CarouselItem

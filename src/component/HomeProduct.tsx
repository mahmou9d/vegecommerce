...
console.log(products,"product")
  ...
  return (
    ...
    after:bg-[#01e281] after:opacity-20 after:rounded-md after:z-[1]"
        ...
        <Button className="bg-[#01e281] my-8 text-[#122d40] font-extrabold rounded-full px-10 py-7 text-[16px] tracking-[0.5px] hover:bg-[#122d40] hover:text-[#01e281]">
          View all Products
        </Button>
      </div>
